  ...
  input_schema: {
    ...
    properties: {
      ...
      content_html: {
        type: "string",
        description:
          "บทความเต็ม HTML ใช้ <p>, <h2>, <ul>, <li> ความยาว 400-600 คำ ย่อหน้าแรกต้องเปิดด้วยวันสำคัญก่อนแล้วค่อยโยงเข้าหัวข้อสุขภาพ",
      },
      category: {
        type: "string",
...
- **ย่อหน้าแรกต้องเปิดด้วยวันสำคัญก่อน** แล้วค่อยโยงเข้าหัวข้อสุขภาพ ไม่ใช่เอ่ยชื่อวันแค่ผ่านๆ
