...
const ARTICLE_TOOL = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      category: {
        type: "string",
        description: "ชื่อวันสำคัญประจำวัน — ใช้วันสำคัญจริง (ไทยหรือสากล) ของวันนั้นเสมอ แม้จะไม่เกี่ยวกับสุขภาพ เช่น 'วันมรดกโลก', 'วันครู', 'วันสงกรานต์', 'วันหัวใจโลก' แล้วเชื่อมโยงเข้ากับเนื้อหาในบทความ ห้ามตั้งชื่อวันขึ้นมาเอง",
      },
    },
