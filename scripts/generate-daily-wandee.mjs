...
const SITES = [
  ...
  {
    slug: "jia1669",
    audience: "บุคลากรทางการแพทย์ โรงพยาบาล คลินิก ที่สนใจอุปกรณ์การแพทย์",
    topic: "อุปกรณ์การแพทย์ เครื่องมือแพทย์ การดูแลรักษาอุปกรณ์ มาตรฐานการใช้งาน",
    tone: "วิชาการแต่อ่านง่าย เน้นประโยชน์ใช้สอย ข้อมูลจำเพาะ",
    examples: "เช่น: วิธีเลือกเครื่องวัดความดัน, การดูแลเครื่อง defibrillator, มาตรฐานอุปกรณ์ ICU, เทรนด์นวัตกรรมอุปกรณ์แพทย์",
  },
  {
    slug: "morroo",
    audience: "นักศึกษาแพทย์ที่กำลังเตรียมสอบ และแพทย์ที่ต้องการทบทวนความรู้",
    topic: "เนื้อหาวิชาการแพทย์ สรีรวิทยา กายวิภาค โรค การวินิจฉัย การรักษา เหมาะกับการสอบใบประกอบวิชาชีพ",
    tone: "เชิงวิชาการ แม่นยำ มีหลักการ เน้น key concepts สำหรับสอบ",
    examples: "เช่น: กลไก heart failure, การแปลผล ECG, ยา beta-blocker ใช้เมื่อไหร่, DKA vs HHS ต่างกันอย่างไร",
  },
  {
    slug: "pharmru",
    audience: "นักศึกษาเภสัชศาสตร์ที่กำลังเตรียมสอบใบประกอบวิชาชีพและสอบประจำภาค",
    topic: "เภสัชวิทยา pharmacokinetics drug interactions ยากลุ่มต่างๆ การคำนวณยา dispensing",
    tone: "เชิงวิชาการ เน้น mnemonics และ key points ที่ออกสอบบ่อย",
    examples: "เช่น: กลุ่มยา beta-lactam, การคำนวณ creatinine clearance, ยาห้ามใช้ขณะตั้งครรภ์, drug interaction ที่สำคัญ",
  },
  {
    slug: "roodee",
    audience: "นักเรียนมัธยมปลายที่เตรียมสอบเข้ามหาวิทยาลัย สายวิทย์-สุขภาพ (TCAS/PAT)",
    topic: "ความรู้วิชาชีววิทยา เคมี ฟิสิกส์ คณิตศาสตร์ ที่เกี่ยวข้องกับสายสุขภาพ เทคนิคการสอบ",
    tone: "กระตุ้นแรงจูงใจ เข้าใจง่าย มีตัวอย่างโจทย์ เหมาะนักเรียน ม.ปลาย",
    examples: "เช่น: เทคนิคจำ DNA replication, โจทย์เคมีที่ออกสอบบ่อย, วิธีอ่านหนังสือก่อนสอบ TCAS, คณะแพทย์แต่ละมหาลัยต้องการอะไร",
  },
  {
    slug: "emr",
    audience: "แพทย์ พยาบาล และบุคลากรโรงพยาบาลที่ใช้ระบบ Electronic Medical Record",
    topic: "ระบบ EMR การบันทึกข้อมูลผู้ป่วย workflow โรงพยาบาล digital health มาตรฐาน HL7/FHIR",
    tone: "วิชาชีพ ปฏิบัติได้จริง เน้น workflow และ best practice",
    examples: "เช่น: วิธีบันทึก SOAP note ที่ดี, มาตรฐาน ICD-10, การจัดการ medication order ใน EMR, แนวโน้ม AI ใน EMR",
  },
];
