...
const ARTICLE_TOOL = {
  ...
  input_schema: {
    ...
    properties: {
      ...
      category: { type: "string", description: "หมวดหมู่สั้นๆ เช่น 'CPR', 'เภสัชวิทยา', 'ข้อสอบแพทย์'" },
    },
...
คุณเป็นนักเขียนบทความสำหรับเว็บไซต์ที่มีกลุ่มเป้าหมายเป็น: ${site.audience}

เขียนบทความ "วันดีๆ" ประจำวัน — เนื้อหาความรู้ที่เกี่ยวกับ: ${site.topic}
